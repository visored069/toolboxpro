...
(function (global) {
    ...
    var TOOLS = [
        { id: 'json-formatter', name: 'JSON Formatter', slug: 'json-formatter', description: 'Format, validate, and beautify your JSON data instantly.', category: 'Developer', keywords: 'json format validate beautify minify', icon: 'fa-code', component: 'json-formatter.html', relatedTools: ['json-to-csv', 'markdown-preview', 'regex-tester'] },
        ...
        { id: 'base64-encoder-decoder', name: 'Base64 Encoder/Decoder', slug: 'base64-encoder-decoder', description: 'Encode and decode Base64 strings instantly in your browser.', category: 'Developer', keywords: 'base64 encode decode', icon: 'fa-file-code', component: 'base64-encoder-decoder.html', relatedTools: ['url-encoder-decoder', 'hash-generator', 'json-formatter'] },
        { id: 'url-encoder-decoder', name: 'URL Encoder/Decoder', slug: 'url-encoder-decoder', description: 'Encode and decode URLs and query strings safely.', category: 'Developer', keywords: 'url encode decode percent', icon: 'fa-link', component: 'url-encoder-decoder.html', relatedTools: ['base64-encoder-decoder', 'regex-tester', 'json-formatter'] },
        ...
        { id: 'json-to-csv', name: 'JSON to CSV', slug: 'json-to-csv', description: 'Convert JSON arrays to CSV format for spreadsheets instantly.', category: 'Developer', keywords: 'json csv convert export spreadsheet', icon: 'fa-table', component: 'json-to-csv.html', relatedTools: ['json-formatter', 'markdown-preview', 'timestamp-converter'] },
        ...
        { id: 'html-to-text', name: 'HTML to Text', slug: 'html-to-text', description: 'Strip HTML tags and extract clean plain text from markup.', category: 'Developer', keywords: 'html strip tags text extract convert', icon: 'fa-eraser', component: 'html-to-text.html', relatedTools: ['markdown-preview', 'word-counter', 'text-diff-checker'] },
