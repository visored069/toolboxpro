...
(function (global) {
    ...
    var TOOLS = [
        ...
        { slug: 'midjourney', name: 'Midjourney', company: 'Midjourney', desc: 'AI art generator. Photorealistic images, artistic styles, and architectural renders.', category: 'AI Image Gen', icon: 'fa-image', color: '#000000', pricing: 'paid', badges: ['top','wellknown'], lastVerified: '2026-09-20', url: 'https://midjourney.com' },
        ...
        { slug: 'stable-diffusion', name: 'Stable Diffusion', company: 'Stability AI', desc: 'Open-source AI image generation. Local deployment, fine-tuning, ControlNet, and community support.', category: 'AI Image Gen', icon: 'fa-wand-sparkles', color: '#a855f7', pricing: 'free', badges: ['free','wellknown'], lastVerified: '2026-09-20', url: 'https://stability.ai' },
        ...
        { slug: 'flux', name: 'Flux', company: 'Black Forest Labs', desc: 'Open-source image model. Photorealistic output, available via API or local deployment.', category: 'AI Image Gen', icon: 'fa-bolt-lightning', color: '#22c55e', pricing: 'free', badges: ['free','new'], lastVerified: '2026-09-20', url: 'https://blackforestlabs.ai' },
        { slug: 'playground-ai', name: 'Playground AI', company: 'Playground', desc: 'AI image generation and editing. Create and edit images with simple prompts.', category: 'AI Image Gen', icon: 'fa-sun', color: '#eab308', pricing: 'freemium', badges: ['free'], lastVerified: '2026-09-20', url: 'https://playground.com' },
        ...
        { slug: 'v0-by-vercel', name: 'v0 by Vercel', company: 'Vercel', desc: 'AI generates production-ready React/Next.js UI. Tailwind CSS, shadcn/ui components.', category: 'AI Code', icon: 'fa-v', color: '#000000', pricing: 'freemium', badges: ['top','new'], lastVerified: '2026-09-20', url: 'https://v0.dev' },
        { slug: 'bolt-new', name: 'Bolt.new', company: 'StackBlitz', desc: 'Prompt-to-app in the browser. Build full-stack web apps with AI — code, preview, and deploy.', category: 'AI Code', icon: 'fa-bolt', color: '#1389fd', pricing: 'freemium', badges: ['new','wellknown'], lastVerified: '2026-09-20', url: 'https://bolt.new' },
        ...
        { slug: 'udio', name: 'Udio', company: 'Udio', desc: 'AI music generation. Create any genre with vocals and full arrangements.', category: 'AI Audio', icon: 'fa-headphones', color: '#8b5cf6', pricing: 'freemium', badges: ['new'], lastVerified: '2026-09-20', url: 'https://udio.com' },
        { slug: 'elevenlabs', name: 'ElevenLabs', company: 'ElevenLabs', desc: 'AI voice synthesis with voice cloning, text-to-speech, voice changer, and dubbing.', category: 'AI Audio', icon: 'fa-microphone', color: '#000000', pricing: 'freemium', badges: ['top','wellknown'], lastVerified: '2026-09-20', url: 'https://elevenlabs.io' },
        ...
        { slug: 'murf-ai', name: 'Murf AI', company: 'Murf', desc: 'AI voiceover platform with narration in many voices and languages.', category: 'AI Audio', icon: 'fa-volume-high', color: '#7c3aed', pricing: 'paid', badges: [], lastVerified: '2026-09-20', url: 'https://murf.ai' },
        ...
        { slug: 'looka', name: 'Looka', company: 'Looka', desc: 'AI logo maker and brand identity. Generate logos, business cards, and social media kits.', category: 'AI Design', icon: 'fa-palette', color: '#6366f1', pricing: 'paid', badges: [], lastVerified: '2026-09-20', url: 'https://looka.com' },
        ...
        { slug: 'vercel-ai-sdk', name: 'Vercel AI SDK', company: 'Vercel', desc: 'Build AI apps with TypeScript. Streaming UI, edge functions, model providers, chatbot templates.', category: 'AI Code', icon: 'fa-triangle-exclamation', color: '#000000', pricing: 'free', badges: ['free','new'], lastVerified: '2026-09-20', url: 'https://sdk.vercel.ai' },
        ...
        { slug: 'obviously-ai', name: 'Obviously AI', company: 'Obviously AI', desc: 'No-code predictive analytics. Upload data and get predictions without ML expertise.', category: 'AI Productivity', icon: 'fa-microscope', color: '#10b981', pricing: 'paid', badges: [], lastVerified: '2026-09-20', url: 'https://obviously.ai' },
        ...
        { slug: 'gamma', name: 'Gamma', company: 'Gamma', desc: 'AI-powered presentations, documents, and websites. No slides — a web-native format.', category: 'AI Design', icon: 'fa-presentation-screen', color: '#8b5cf6', pricing: 'freemium', badges: ['top','wellknown'], lastVerified: '2026-09-20', url: 'https://gamma.app' },
        ...
        { slug: 'tome', name: 'Tome', company: 'Tome', desc: 'AI storytelling platform. Generate presentations, one-pagers, and documents from prompts.', category: 'AI Design', icon: 'fa-book-open', color: '#000000', pricing: 'freemium', badges: [], lastVerified: '2026-09-20', url: 'https://tome.app' },
